...
function showErrorMessages(input, msg) {
    const field = input.parentElement; // Do input pegaremos o seu campo de formulário pai.
    const field_error = field.querySelector('.error-message'); // Do pai, selecionamos o campo das mensagens de erro.
...
function checkForEmptyFields(...inputs) {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMessages(input, 'Campo em branco.'); // Se não houver valor em cada elemento, gere um erro tal.
    });
}
;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form_control */ "./src/webpack/form_control.ts");

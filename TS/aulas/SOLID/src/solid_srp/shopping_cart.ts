...
class ShoppingCart {
    ...
    get items(): Readonly<cart_item[]> {
        return this._items;
    }

    get order_status(): Readonly<order_status> {
        return this._order_status;
    }
};

const cart = new ShoppingCart;
const pizza: cart_item = { name: 'Mozzarela', price: 0.9 };
const soda: cart_item = { name: 'Coke', price: 1.7 };
const chocolate: cart_item = { name: 'Snickers', price: 0.5 };
const wine: cart_item = { name: 'Red Wine', price: 12.12 };

...
import { ShoppingCart } from "./shopping_cart";                                 // Classe [Entidade] responsável pelo "Carrinho de Compras"
import { Messages } from "../services/messages";                                // Classe [Serviço] responsável pela mensageria.
import { Persistency } from "../services/persistency";                          // Classe [Serviço] responsável por gerenciar a atividade corrente.
...
export class Order {
    ...
    checkout(): void {                                                              // Método responsável por finalizar o pedido.
        ...
        this.msg.send_message(`Seu pedido no total de R$ ${this.cart.total(this.discount)} foi processado com sucesso!`);
